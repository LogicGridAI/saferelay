# SafeRelay CLI
**Zero-trust local DLP for AI-era workflows — 54+ threat patterns across 8+ countries.**
...
```
## What gets redacted
Free tier covers core patterns (IPv4 addresses, cloud access keys). Pro unlocks all 54+ patterns below.
| Pattern |
|---|
| IPv4 addresses |
...
| US SSN / EIN / Green Card |
| EU IBAN / VAT |
| UK NINO |
| Nigeria NIN / BVN / bank / phone |
| Canada SIN |
| India Aadhaar / PAN |
| South Africa ID |
| Australia TFN |
...
| Pro | \$7.99/mo or \$59/yr | 54+ patterns, full vault |
